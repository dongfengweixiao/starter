...
class MobileStarterApp extends StatelessWidget with WatchItMixin {
  const MobileStarterApp({super.key, this.accent});
  ...
  Widget build(BuildContext context) {
    ...
    final phoenix = phoenixTheme(color: accent ?? kStarterAppDefaultColor);
